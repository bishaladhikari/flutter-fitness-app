...
import 'package:rakurakubazzar/pages/auth/email_confirm_page.dart';
import 'package:rakurakubazzar/pages/auth/email-forgot-password-page.dart';
import 'package:rakurakubazzar/pages/auth/forget_password.dart';
import 'package:rakurakubazzar/pages/auth/login-page.dart';
import 'package:rakurakubazzar/pages/auth/register-page.dart';
import 'package:rakurakubazzar/pages/card-payment/card-payment-page.dart';
import 'package:rakurakubazzar/pages/cart/cart-page.dart';
import 'package:rakurakubazzar/pages/cash-on-delivery/cash-on-delivery-page.dart';
import 'package:rakurakubazzar/pages/change-password/change_password_page.dart';
import 'package:rakurakubazzar/pages/checkout/checkout-page.dart';
import 'package:rakurakubazzar/pages/combo/combo-detail-page.dart';
import 'package:rakurakubazzar/pages/from-same-seller/from-same-seller-page.dart';
import 'package:rakurakubazzar/pages/home/components/discount-view.dart';
import 'package:rakurakubazzar/pages/main_page.dart';
import 'package:rakurakubazzar/pages/no-internet/no-internet-page.dart';
import 'package:rakurakubazzar/pages/order-complete/order-complete-page.dart';
import 'package:rakurakubazzar/pages/order-details/order-detail-page.dart';
import 'package:rakurakubazzar/pages/order_review/order_review_page.dart';
import 'package:rakurakubazzar/pages/privacy/privacy-page.dart';
import 'package:rakurakubazzar/pages/product-details/product-detail-page.dart';
import 'package:rakurakubazzar/pages/product-view-more/product-view-more-page.dart';
import 'package:rakurakubazzar/pages/rating-reviews/ratings-reviews-page.dart';
import 'package:rakurakubazzar/pages/search/search-page.dart';
import 'package:rakurakubazzar/pages/select_payment_method/select-payment-method-page.dart';
import 'package:rakurakubazzar/pages/settings/settings-page.dart';
import 'package:rakurakubazzar/pages/store/store-page.dart';
import 'package:rakurakubazzar/pages/wish/wishlistpage.dart';
import 'package:rakurakubazzar/pages/orders/orders_page.dart';
